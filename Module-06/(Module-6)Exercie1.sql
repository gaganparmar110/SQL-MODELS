...
--****************************
select * from module6.Students where StudentName='Gagan' order by StudentId;

select * from module6.StudentDetails where Age=21 order by StudentId

--*****************************
Insert into module6.Students vALUES('Gagan','9755776178','abc');
Insert into module6.StudentDetails VALUES(1,'parmargagan@gmail.com',22);
